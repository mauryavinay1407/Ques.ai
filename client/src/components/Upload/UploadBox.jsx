        ...
        <div className="w-full border-2 border-1-black shadow-lg rounded-lg h-auto">
            <div className="flex justify-center items-center md:my-5 my-2">
                ...
                <img
                    ...
                    alt="Logo"
                    className="w-14 md:w-18 object-fill"
                />
            </div>
            {/* text section */}
            <div className="text-center px-2">
                <p className="font-roboto text-black text-sm md:text-lg ">
                ...
                <button className="border-primary border rounded-3xl py-[7px] px-3 md:px-4 mb-4 md:mb-8 font-roboto font-semibold text-sm md:text-md text-primary my-2 md:my-4">
                    Select File
                </button>
            </div>
        </div>
